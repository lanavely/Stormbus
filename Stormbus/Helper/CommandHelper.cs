...
namespace Stormbus.UI.Helper
{
    public static class CommandHelper
    {
        ...
        public static void UpdateItemsByCountChanged<T>(ObservableCollection<ResultItemModel> items, ushort newCount,
            ushort oldCount, ushort address)
        {
        ...
        public static void UpdateItemsByAddressChanged(ObservableCollection<ResultItemModel> items, ushort newAddress,
            ushort oldAddress)
        {
